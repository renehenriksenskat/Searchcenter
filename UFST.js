	...
	function execOperation() {
			try {
                ...
                if (brandingIndhold == undefined) {
                    ...
                    $('.o365cs-nav-tenantBranding').html("<a class='o365cs-nav-tenantLogo_SKM o365button_SKM' role='link' id='O365_MainLink_TenantLogo_SKM' href='https://skat.sharepoint.com/sites/ufst' title='Udviklings- og Forenklingsstyrelsen' aria-label='Udviklings- og Forenklingsstyrelsen'><img id='O365_MainLink_TenantLogoImg_SKM' src='https://skat.sharepoint.com/sites/ufst/SiteAssets/__hubLogo__Ufst_logo.png' title='Udviklings- og Forenklingsstyrelsen' alt='Udviklings- og Forenklingsstyrelsen' style='max-height: 40px; margin: 5px;'></a>");
                }
					}
			catch (err) {
				alert(err);
