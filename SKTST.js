	...
	function execOperation() {
			try {
                ...
                if (brandingIndhold == undefined) {
                    ...
                    $('.o365cs-nav-tenantBranding').html("<a class='o365cs-nav-tenantLogo_SKM o365button_SKM' role='link' id='O365_MainLink_TenantLogo_SKM' href='https://skat.sharepoint.com/sites/sktst' title='Skattestyrelsen' aria-label='Skattestyrelsen'><img id='O365_MainLink_TenantLogoImg_SKM' src='https://skat.sharepoint.com/sites/sktst/SiteAssets/__hubLogo__Skatst_logo.png' title='Skattestyrelsen' alt='Skattestyrelsen' style='max-height: 40px; margin: 5px;'></a>");
                }
					}
			catch (err) {
				alert(err);
