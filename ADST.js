	...
	function execOperation() {
			try {
                ...
                if (brandingIndhold == undefined) {
                    ...
                    $('.o365cs-nav-tenantBranding').html("<a class='o365cs-nav-tenantLogo_SKM o365button_SKM' role='link' id='O365_MainLink_TenantLogo_SKM' href='https://skat.sharepoint.com/sites/adst' title='Administrations- og Servicestyrelsen' aria-label='Administrations- og Servicestyrelsen'><img id='O365_MainLink_TenantLogoImg_SKM' src='https://skat.sharepoint.com/sites/adst/SiteAssets/__hubLogo__Asst_logo.png' title='Administrations- og Servicestyrelsen' alt='Administrations- og Servicestyrelsen' style='max-height: 40px; margin: 5px;'></a>");
                }
					}
			catch (err) {
				alert(err);
