	...
	function execOperation() {
			try {
                ...
                if (brandingIndhold == undefined) {
                    ...
                    $('.o365cs-nav-tenantBranding').html("<a class='o365cs-nav-tenantLogo_SKM o365button_SKM' role='link' id='O365_MainLink_TenantLogo_SKM' href='https://skat.sharepoint.com/sites/motorst' title='Motorstyrelsen' aria-label='Motorstyrelsen'><img id='O365_MainLink_TenantLogoImg_SKM' src='https://skat.sharepoint.com/sites/motorst/SiteAssets/__hubLogo__Motorst_logo.png' title='Motorstyrelsen' alt='Motorstyrelsen' style='max-height: 40px; margin: 5px;'></a>");
                }
					}
			catch (err) {
				alert(err);
